...
# Allow running the script directly from the py/ directory without installing.
sys.path.insert(0, os.path.dirname(__file__))

from specter_card.connection import Card, Simulator, ISOException
from specter_card.securechannel import SecureChannel, SecureError, SUPPORTED_SECURE_CHANNEL_MODES
